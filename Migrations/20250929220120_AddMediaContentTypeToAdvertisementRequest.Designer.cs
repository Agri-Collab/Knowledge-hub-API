...
namespace AgriConnect.Migrations
{
    ...
    [Migration("20250929220120_AddMediaContentTypeToAdvertisementRequest")]
    partial class AddMediaContentTypeToAdvertisementRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("api.Models.AdvertisementRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AdvertisementRequests");
                });
            ...
            modelBuilder.Entity("api.Models.ChatMessage", b =>
                {
                    b.HasOne("api.Models.ChatSession", null)
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("api.Models.User", b =>
                {
                    b.Navigation("AdvertisementRequests");
